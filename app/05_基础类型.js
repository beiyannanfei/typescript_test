...
let listA = [1, 2, 3]; //数组定义方式一
let listB = [4, 5, 6]; //数组定义方式二
//元组 Tuple
//元组类型允许表示一个已知元素数量和类型的数组，各元素的类型不必相同
let t1 = ["hello", 1234]; //定义一对值分别为string和number类型的元组
// t1 = [1, "a"];   //error
...
/*enum Color3 {Red = "myRed", Green = "myGreen", Blue = "myBlue"}     //js中不会报错,但是不推荐
 ...
 console.log(c3);*/
let colorName = Color1[2]; //枚举类型提供的一个便利是你可以由枚举的值得到它的名字
...
let unusable = undefined; //声明一个void类型的变量没有什么大用，因为你只能为它赋予undefined和null
let unusable1 = null;
...
//另一个为as语法：
let strLength0 = someValue.length; //两种形式是等价的。 至于使用哪个大多数情况下是凭个人喜好；然而，当你在TypeScript里使用JSX时，只有 as语法断言是被允许的。
